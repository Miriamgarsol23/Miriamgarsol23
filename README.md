# Hi there, I'm Miriam García Sollo 👋
### Software Engineering · Applied Mathematics · Algorithmic Problem Solving · Cybersecurity · Data Analysis · AI · Computer Science & Mathematics · Entrepreneurship

Welcome to my GitHub! I'm a **Double Bachelor's Degree student in Computer Science and Mathematics** at the University of Granada (UGR), with a strong focus on **cybersecurity, data analysis and AI**, combined with an entrepreneurial drive and hands-on experience building real-world projects. I believe the most powerful solutions sit at the intersection of rigorous mathematics, solid engineering and strategic thinking.

---

## 🔭 About Me

- 🔐 **Cybersecurity in training:** Selected for the **CyberBootcamp Málaga 2026** (funded by Google.org, organised by the University of Málaga & NICS Lab). Hands-on work in CTF challenges covering web exploitation (SQLi, SSTI, LFI, RCE), reverse engineering, cryptographic attacks and network pivoting.
- 🧮 **Mathematical foundations:** Comfortable turning complex theoretical frameworks (Linear Algebra, Mathematical Analysis, Numerical Methods, Probability) into efficient, well-reasoned code.
- 🚀 **Entrepreneur:** Co-founder of [**Emprendus**](https://www.emprendus.com/), a student-led tech & entrepreneurship community in Seville with active partnerships with **Sevilla Tech, Cámara de Comercio de Sevilla, Fusion Startups, Espacio RES** and the **Entrepreneurship Department at the University of Seville**. Constantly embedded in the startup ecosystem.
...
![CTF](https://img.shields.io/badge/CTF-Web%20·%20Crypto%20·%20Reversing-red?style=flat-square)
...
I'm always open to collaborating on projects bridging **cybersecurity, data, AI and entrepreneurship**, especially anything at the intersection of technical rigour and real-world impact.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=flat-square&logo=linkedin&logoColor=white)](https://linkedin.com/in/miriam-garcía-sollo-11b90535a/)
